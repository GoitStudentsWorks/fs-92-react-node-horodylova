...
`,Te=({isOpen:o,onRequestClose:r})=>{const d={overlay:{backgroundColor:"rgba(0, 0, 0, 0.80)",display:"flex",justifyContent:"center",alignItems:"center"},content:{padding:"0",position:"initial",borderRadius:"10px",background:"var(--white-color)",boxShadow:"0px 4px 4px 0px rgba(64, 123, 255, 0.30)",maxHeight:"95vh",overflowY:"auto"}},i=R(),{gender:a,dailyNorma:x}=z(de),[l,h]=n.useState(a),[u,j]=n.useState(""),[y,g]=n.useState(""),[v,f]=n.useState((x/1e3).toFixed(1)),[m,S]=n.useState(""),c=n.useCallback(()=>{if(!u||!y)return;const w=l==="woman"?.03:.04,W=l==="woman"?.4:.6,M=(u*w+y/60*W).toFixed(2);f(M)},[l,u,y]);n.useEffect(()=>{c()},[c]);const p=w=>{const W=w.target.value,M=parseFloat(W);!isNaN(M)&&M>=1?S(M):W===""&&S("")},T=w=>{w.preventDefault();const W=Number(w.target.water.value)*1e3,M=A().date;i(pe({date:M,waterRate:W})),r()};return e.jsx(k,{isOpen:o,onRequestClose:r,style:d,children:e.jsxs(ue,{children:[e.jsxs(fe,{children:[e.jsx(be,{children:"My daily norma"}),e.jsx("button",{onClick:r,children:e.jsx(H,{width:"24",height:"24"})})]}),e.jsxs(ye,{children:[e.jsxs(Y,{children:["For woman:",e.jsx(V,{children:" V=(M*0,03) + (T*0,4)"})]}),e.jsxs(Y,{children:["For man:",e.jsx(V,{children:" V=(M*0,04) + (T*0,6)"})]})]}),e.jsx(ve,{children:e.jsxs(Ce,{children:[e.jsx(we,{children:"* "}),"V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"," "]})}),e.jsxs(je,{onSubmit:T,children:[e.jsx(Me,{children:"Calculate your rate:"}),e.jsxs(ke,{children:[e.jsxs($,{children:[e.jsx(G,{type:"radio",name:"gender",value:"woman",checked:l==="woman",onChange:()=>h("woman")}),"For woman"]}),e.jsxs($,{children:[e.jsx(G,{type:"radio",name:"gender",value:"man",checked:l==="man",onChange:()=>h("man")}),"For man"]})]}),e.jsxs($,{children:["Your weight in kilograms:",e.jsx(I,{type:"number",name:"weight",min:"0",max:"250",placeholder:"0",value:u,onChange:w=>j(w.target.value)})]}),e.jsxs($,{children:["The time of active participation in sports or other activities with a high physical. load in hours:",e.jsx(I,{type:"number",name:"time",min:"0",placeholder:"0",value:y,onChange:w=>g(w.target.value)})]}),e.jsxs(ze,{children:[e.jsxs(Se,{children:["The required amount of water in liters per day:"," "]}),e.jsxs(De,{children:[" ",parseFloat(v).toFixed(1)," L"]})]}),e.jsxs(We,{children:["Write down how much water you will drink:",e.jsx(I,{required:!0,type:"number",name:"water",placeholder:0,value:m,onChange:p})]}),e.jsx(Ee,{type:"submit",children:"Save"})]})]})})},Re=t.div` 
  display: inline-flex;
  flex-direction: column;
  gap: 12px;
  border-radius: 10px;
...
line-height: 1.3;
color: var(--primary-txt-color);
`;k.setAppElement("#root");const Ie=()=>{const o=z(x=>x.auth.user.dailyNorma),[r,d]=n.useState(!1),i=o?(o/1e3).toFixed(1):"0",a=()=>{d(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs(Re,{children:[e.jsx(Le,{children:"My daily norma"}),e.jsxs(Be,{children:[e.jsxs($e,{children:[i||2," L"]}),e.jsx(Fe,{type:"button",onClick:a,children:e.jsx("span",{children:"Edit"})})]})]}),e.jsx(Te,{isOpen:r,onRequestClose:()=>d(!1)})]})},Ne=t.div`
  display: flex;
  flex-wrap: wrap;
  gap: 16px;
  justify-content: space-between;
...
`,E={Container:Ye,TitleContainer:Ge,EnteredData:Je,Label:Ke,Input:Qe,SaveButtonWrapper:Xe,WaterPortionWrapper:Ue},qe={overlay:{backgroundColor:"rgba(0, 0, 0, 0.8)"},content:{padding:"0",position:"initial",width:"100%"}},ee=({isOpen:o,onRequestClose:r})=>{k.setAppElement("#root");const d=R(),[i,a]=n.useState(50),[x,l]=n.useState(A().time),h=g=>{const{name:v,value:f}=g.currentTarget;switch(v){case"time":l(f);break;case"ml":!isNaN(f)&&f>0&&f<1e4&&a(f);break;default:console.log("ERROR")}},u=()=>{i>=100&&a(Number(i)-50),i<100&&a(50)},j=()=>{a(Number(i)+50)},y=async g=>{g.preventDefault(),r();let v={date:A().date,time:g.target.time.value,value:Number(g.target.ml.value)};try{await d(ce(v)).unwrap(),F.success("Added your new entry!")}catch(f){F.error(f)}};return e.jsx(k,{isOpen:o,onRequestClose:r,style:qe,contentLabel:"Add Water Modal",children:e.jsx("form",{onSubmit:y,children:e.jsxs(E.Container,{children:[e.jsxs(E.TitleContainer,{children:[e.jsx("p",{children:"Add Water"}),e.jsx("button",{onClick:r,children:e.jsx(H,{width:"24",height:"24"})})]}),e.jsxs(E.EnteredData,{children:[e.jsx("p",{className:"title",children:"Choose a value:"}),e.jsx("p",{className:"subtitle",children:"Amount of water:"}),e.jsxs("div",{className:"waterControllers",children:[e.jsx("button",{type:"button",onClick:u,disabled:i<=50,children:e.jsx(X,{width:"24",height:"24"})}),e.jsxs("div",{className:"ml",children:[i," ml"]}),e.jsx("button",{type:"button",onClick:j,disabled:i>=9950,children:e.jsx(q,{width:"24",height:"24"})})]})]}),e.jsxs(E.Label,{children:["Recording time:",e.jsx(E.Input,{type:"time",name:"time",value:x,onChange:h})]}),e.jsxs(E.Label,{children:["Enter the value of the water used:",e.jsx(E.Input,{type:"number",name:"ml",value:i,min:"1",minLength:"1",maxLength:"4",onChange:h})]}),e.jsxs(E.SaveButtonWrapper,{children:[e.jsxs("p",{style:{minWidth:"50px"},children:[i,"ml"]}),e.jsx("button",{type:"submit",children:"Save"})]})]})})})},te=o=>o.calendarWater.dayWater.takingWater,et=o=>o.calendarWater.monthWater,tt=o=>o.calendarWater.percent,oe=Z.memo(()=>{const o=z(tt),[r,d]=n.useState(!1),i=o/100*100,a={background:`linear-gradient(to right, #9EBBFF ${i}%, #D7E3FF ${i}%)`};n.useEffect(()=>{},[o]);const x=()=>{d(!0)},l=()=>{d(!1)};return e.jsxs(Ne,{children:[e.jsxs(Oe,{children:[e.jsx(Ae,{children:"Today"}),e.jsx(Pe,{type:"range",min:"0",max:"100",value:o,style:a,readOnly:!0}),e.jsxs(Ze,{children:[e.jsx(N,{children:"0%"}),e.jsx(N,{children:e.jsxs(He,{children:[Math.ceil(o),"%"]})}),e.jsx(N,{children:"100%"})]})]}),e.jsxs(_e,{onClick:x,children:[e.jsx(Ve,{children:e.jsx("use",{href:L+"#icon-plus-button"})}),"Add Water"]}),e.jsx(ee,{onRequestClose:l,isOpen:r})]})});oe.displayName="WaterRatioPanel";const ot=t.div`
  font-family: Roboto;
  font-size: 24px;
  font-style: normal;
  color: var(--primary-txt-color);
...
font-weight: var(--medium);
line-height: 1.33;
`,yt=({isOpen:o,onRequestClose:r,currentDate:d,selectedDay:i,obj:a})=>{const x={overlay:{backgroundColor:"transparent",display:"flex",justifyContent:"center",alignItems:"center"},content:{padding:"0",position:"initial",maxWidth:"260px",borderRadius:"10px",background:"var(--white-color)",boxShadow:"0px 4px 4px 0px rgba(64, 123, 255, 0.30)"}};return e.jsx(k,{isOpen:o,onRequestClose:r,contentLabel:"Day Details",style:x,children:e.jsxs(xt,{children:[e.jsx(mt,{children:i?`${i}, ${d.toLocaleString("en",{month:"long"})}`:""})," ",e.jsxs(O,{children:[e.jsx(ht,{children:"Daily norma: "}),e.jsxs(gt,{children:[a.dayWaterRate," L"]})]})," ",e.jsxs(O,{children:[e.jsx(ut,{children:"Fulfillment of the daily norm:"})," ",e.jsxs(ft,{children:[a.percent,"%"]})]}),e.jsxs(O,{children:[e.jsx(bt,{children:"Water consumed:"})," ",e.jsx(wt,{children:a.count})]})]})})};Q("SET_SELECTED_DATE");Q("SET_WATER_CONSUMED");const ne=o=>o.water;k.setAppElement("#root");const ie=Z.memo(({dailyNorma:o,fulfillmentPercentage:r,waterConsumed:d})=>{const[i,a]=n.useState(new Date),[x,l]=n.useState(null),[h,u]=n.useState(!1),[j,y]=n.useState({}),g=R(),v=z(et),f=z(ne),m=s=>{const b=s.getFullYear(),C=s.getMonth();return new Date(b,C+1,0).getDate()},S=()=>{const s=new Date(i);s.setMonth(s.getMonth()-1),s.setDate(1);const b=s.toISOString();g(_.selectDayAction(b));const[C,B]=b.split("-");g(P({year:C,month:B})),a(s)},c=()=>{const s=new Date(i);s.setMonth(s.getMonth()+1),s.setDate(1);const b=String(s.getFullYear()),C=String(s.getMonth()+1).padStart(2,"0"),B=String(s.getDate()).padStart(2,"0"),se=`${b}-${C}-${B}`;g(_.selectDayAction(se)),g(P({year:b,month:C})),a(s)};n.useEffect(()=>{const s=setInterval(()=>a(new Date),6e4);return()=>clearInterval(s)},[]);const p=(s,b)=>{try{l(s),u(!0),y(b)}catch(C){console.log(C)}},T=m(i),w=i.toLocaleString("en",{month:"long"}),W=i.getFullYear(),M=new Date().getMonth()+1,ae=f.selectedDate.split("-")[1],le=String(M).padStart(2,"0");return e.jsxs("div",{children:[e.jsxs(nt,{children:[e.jsx(ot,{children:"Month"}),e.jsxs(it,{children:[e.jsx(U,{onClick:S,children:e.jsx(ct,{})}),e.jsx(rt,{children:`${w}, ${W}`}),e.jsx(U,{disabled:le===ae,onClick:c,children:e.jsx(pt,{})})]})]}),e.jsx(at,{children:Array.from({length:T},(s,b)=>b+1).map(s=>{const b=v[s],C=b?b.percent:0;return e.jsxs(lt,{onClick:()=>p(s,b),children:[e.jsx(st,{$percent:C,children:s}),e.jsxs(dt,{children:[C,"%"]})]},s)})}),e.jsx(yt,{obj:j,isOpen:h,onRequestClose:()=>u(!1),currentDate:i,selectedDay:x,dailyNorma:o,fulfillmentPercentage:r,waterConsumed:d})]})});ie.displayName="Calendar";const vt=t.div`
// margin-bottom: 24px;
...
`,Ft=`${L}#icon-pencil`,Bt=`${L}#icon-trash`,It=`${L}#icon-cup`,Nt=({id:o,water:r,time:d,onEditButtonClick:i,handleDeletebutton:a})=>e.jsxs(Dt,{children:[e.jsx(zt,{children:e.jsx("use",{href:It})}),e.jsx(St,{children:`${r} ml`}),e.jsx(Wt,{children:d}),e.jsxs(Rt,{children:[e.jsx(Lt,{onClick:()=>i(o),children:e.jsx(Et,{children:e.jsx("use",{href:Ft})})}),e.jsx($t,{onClick:()=>a(o),children:e.jsx(Tt,{children:e.jsx("use",{href:Bt})})})]})]}),Ot=t.div`
  background-color: var(--white-color);
  width: 280px;
  height: 648px;
...
`,oo="_Modal_183m8_1",no="_Overlay_183m8_23",J={Modal:oo,Overlay:no},io=({isOpen:o,onRequestClose:r,waterId:d})=>{const i=R(),a=()=>{i(ge(d)),r()};return k.setAppElement("#root"),e.jsx(k,{isOpen:o,overlayClassName:J.Overlay,className:J.Modal,onRequestClose:r,contentLabel:"Example Modal",children:e.jsxs(Jt,{children:[e.jsxs(qt,{children:[e.jsx(Kt,{children:"Delete entry"}),e.jsx("svg",{onClick:r,width:"24",height:"24",cursor:"pointer",children:e.jsx("use",{href:`${he}#icon-close-cross`})})]}),e.jsx(eo,{children:"Are you sure you want to delete the entry?"}),e.jsxs(to,{children:[e.jsx(Qt,{onClick:a,children:"Delete"}),e.jsx(Xt,{onClick:r,children:"Cancel"})]})]})})};k.setAppElement("#root");const ro=`${L}#icon-plus-blue`,re=Z.memo(()=>{const o=z(te)||[],r=o.length>0?o.slice().sort((m,S)=>{const c=m.time.split(":").map(Number),p=S.time.split(":").map(Number);return c[0]!==p[0]?c[0]-p[0]:c[1]-p[1]}):o,[d,i]=n.useState(!1),[a,x]=n.useState(!1),[l,h]=n.useState(!1),[u,j]=n.useState(0),y=()=>{i(!0)},g=()=>{i(!1)},v=m=>{j(m),x(!0)},f=m=>{j(m),h(!0)};return e.jsxs(vt,{children:[e.jsx(Ct,{children:"Today"}),e.jsx(Mt,{children:r&&r.map(m=>e.jsx(Nt,{water:m.value,time:m.time,id:m._id,onEditButtonClick:v,handleDeletebutton:f},m._id))}),e.jsxs(jt,{onClick:y,children:[e.jsx(kt,{children:e.jsx("use",{xlinkHref:ro})}),e.jsx("span",{children:"Add water"})]}),e.jsx(ee,{onRequestClose:g,isOpen:d}),a&&e.jsx(Ut,{isOpen:a,onRequestClose:()=>x(!1),waterId:u}),l&&e.jsx(io,{isOpen:l,onRequestClose:()=>h(!1),waterId:u})]})});re.displayName="TodayList";const ao=t.div`
margin-bottom: 35px;
width: 100%;
...
`,K="/fs-92-react-node-horodylova/assets/Mobile-Bottle-home-screen@1x-40823e6e.png",lo="/fs-92-react-node-horodylova/assets/Mobile-Bottle-home-screen@2x-6bf25102.png",so="/fs-92-react-node-horodylova/assets/Tablet-Bottle-Home-Screen@1x-15e31eb4.png",po="/fs-92-react-node-horodylova/assets/Tablet-Bottle-Home-Screen@2x-27cd4c82.png",co="/fs-92-react-node-horodylova/assets/Desk-Botle-Home-screen@1x-b43174f4.png",xo="/fs-92-react-node-horodylova/assets/Desk-Botle-Home-screen@2x-d7419d88.png",ho=()=>e.jsx(ao,{children:e.jsx("img",{srcSet:`${K} 1x, ${lo} 2x, 
                         ${so} 1x, ${po} 2x, 
                         ${co} 1x, ${xo} 2x`,src:K,alt:"bottle"})}),go="/fs-92-react-node-horodylova/assets/back_desktop@1x-88afa2b3.png",mo="/fs-92-react-node-horodylova/assets/back_desktop@2x-17852ecc.png",uo="/fs-92-react-node-horodylova/assets/back_tablet@1x-79e75131.png",fo="/fs-92-react-node-horodylova/assets/back_tablet@2x-c9456ce0.png",bo="/fs-92-react-node-horodylova/assets/back_mobile@1x-a5bd490b.png",wo="/fs-92-react-node-horodylova/assets/back_mobile@2x-82cfa4ff.png",yo=t.section`
position: relative;
background-color: var(--white-color);
...
`,ko=o=>o.water.selectDate,zo=()=>{const o=R(),r=z(ne),d=z(ko),[i,a]=r.selectedDate.split("-");return n.useEffect(()=>{o(me())},[]),n.useEffect(()=>{o(P({year:i,month:a}))},[d]),e.jsx(yo,{className:"background",children:e.jsx("div",{className:"container",children:e.jsxs(vo,{children:[e.jsxs(Co,{children:[e.jsx(Ie,{}),e.jsx(ho,{}),e.jsx(oe,{})]}),e.jsxs(jo,{children:[e.jsx(re,{}),e.jsx(ie,{})]})]})})})};export{zo as default};
