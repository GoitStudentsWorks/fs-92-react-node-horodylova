...
`,y=()=>{const a=d();function s(){a("/register")}return e.jsxs(u,{children:[e.jsx(f,{children:"Water consumption tracker"}),e.jsx(b,{children:"Record daily water intake and track"}),e.jsx(w,{children:"Tracker Benefits"}),e.jsxs(g,{children:[e.jsxs(r,{children:[e.jsx(o,{children:e.jsx("use",{href:t+"#icon-calendar"})}),"Habit drive"]}),e.jsxs(r,{children:[e.jsx(o,{children:e.jsx("use",{href:t+"#icon-statistics"})}),"View statistics"]}),e.jsxs(r,{children:[e.jsx(o,{children:e.jsx("use",{href:t+"#icon-setting"})}),"Personal rate setting"]})]}),e.jsx(j,{type:"button",onClick:s,children:"Try tracker"})]})},k=n.div`
